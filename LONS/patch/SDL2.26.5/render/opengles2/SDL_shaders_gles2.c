...
//========== LONS add it start ========
/* gray conversion, 4 bit image only */
static const char GLES2_Fragment_TextureGray[] =                 \
"uniform sampler2D u_texture;\n"                                \
"varying mediump vec4 v_color;\n"                               \
"varying SDL_TEXCOORD_PRECISION vec2 v_texCoord;\n"             \
"\n"                                                            \
...
const char *GLES2_GetShader(GLES2_ShaderType type)
{
    ...
    case GLES2_SHADER_FRAGMENT_TEXTURE_EXTERNAL_OES:
        ...
        //LONS add it ============
    case GLES2_SHADER_FRAGMENT_TEXTURE_TEXTUREGRAY:
        return GLES2_Fragment_TextureGray;
        //LONS add it end ============
    default:
        return NULL;
    }
